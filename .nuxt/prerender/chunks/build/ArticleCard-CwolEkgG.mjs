import { v as vue_exports, s as server_renderer_exports, N as NuxtLink } from '../virtual/entry.mjs';
import { T as TagBadge_default } from './TagBadge-Do9pLAY2.mjs';
import { A as ArticleMeta_default } from './ArticleMeta-CblSVYkk.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push((0, server_renderer_exports.ssrRenderComponent)(_component_NuxtLink, {
        ...
        default: (0, vue_exports.withCtx)((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<h2 class="text-lg font-semibold mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.article.title)}</h2>`);
            if (__props.article.description) _push2(`<p class="text-sm text-gray-600 dark:text-gray-400 mb-3 line-clamp-2"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.article.description)}</p>`);
            else _push2(`<!---->`);
            _push2(`<div class="flex items-center justify-between"${_scopeId}><div class="flex items-center gap-2"${_scopeId}>`);
            _push2((0, server_renderer_exports.ssrRenderComponent)(_component_ArticleMeta, {
              date: __props.article.date,
              "word-count": __props.article.wordCount,
              "reading-time": __props.article.readingTime
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            if ((_a = __props.article.tags) == null ? void 0 : _a.length) {
              _push2(`<div class="flex items-center gap-1.5"${_scopeId}><!--[-->`);
              (0, server_renderer_exports.ssrRenderList)(__props.article.tags, (tag) => {
                _push2((0, server_renderer_exports.ssrRenderComponent)(_component_TagBadge, {
                  key: tag,
                  tag
                }, null, _parent2, _scopeId));
              });
            ...
            (0, vue_exports.createVNode)("div", { class: "flex items-center justify-between" }, [(0, vue_exports.createVNode)("div", { class: "flex items-center gap-2" }, [(0, vue_exports.createVNode)(_component_ArticleMeta, {
              ...
              "word-count",
              "reading-time"
            ])]), ((_b = __props.article.tags) == null ? void 0 : _b.length) ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", {
              key: 0,
...
//# sourceMappingURL=ArticleCard-CwolEkgG.mjs.map
