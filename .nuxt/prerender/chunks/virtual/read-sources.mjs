...
import { join } from 'file://C:/codex_learn/codex_list/blog/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';

async function readSourcesFromFilesystem(filename) {
  if (!true) {
    return null
  }
  const path = join("C:\\codex_learn\\codex_list\\blog\\node_modules\\.cache\\nuxt\\sitemap", filename);
